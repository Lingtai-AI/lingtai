...
- **Subfolders:**
  ...
  - `tui/internal/processscan/` — shared ps-based `lingtai run <agentDir>` and Puffo ACP registry-backed process detection used by launch and inventory
