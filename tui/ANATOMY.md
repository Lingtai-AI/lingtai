...
- **Handoff correction:** the older separate-program description below is superseded for Open Existing. The launcher, canonical Bodhi loading view, and prepared real App share one Bubble Tea program; only typed fallback/fatal outcomes release terminal ownership before outside-program handling.
