...
- **Would this skill help others?** → if so, publish it to `../.library_shared/<name>/`. The shared library is what every agent in the network reads; every contribution makes it larger.
