...
func (m SettingsModel) View() string {
	...
	// Title bar
	title := StyleTitle.Render(i18n.T("app.title")) + " " + StyleAccent.Render("·") + " " + StyleTitle.Render(i18n.T("settings.title"))
	escHint := lipgloss.NewStyle().Foreground(ColorAccent).Render("[esc] ") + StyleSubtle.Render(i18n.T("settings.back"))
