...
| `enrichRecord`, `RoleFor`, `enterability` | `tui/internal/inventory/inventory.go:211` | Read `.agent.json`, derive role/admin/IM/heartbeat/lock state, and mark unreadable, human, phantom, or pathless records as non-enterable with a typed reason and optional detail. |
