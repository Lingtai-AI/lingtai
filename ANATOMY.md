...
- **`.github/workflows/release.yml`** — PR/manual native validation and tag-only publication for the experimental Windows amd64 TUI/Portal preview, plus the existing source release and Homebrew update; it does not publish kernel bundles or Gitee assets. See `RELEASING.md`.
