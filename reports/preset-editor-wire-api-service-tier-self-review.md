...
- Anatomy: updated `tui/internal/tui/ANATOMY.md` for API mode and Fast mode rows.
...
- Non-standard `service_tier` values are preserved but displayed as default in the simplified radio strip until the user changes the row.
