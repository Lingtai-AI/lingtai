...
invoke_case() (
  ...
  export EXPECTED_DESKTOP_VERSION="0.1.6"
...
assert_file "$success/home/.local/share/lingtai-desktop/versions/0.1.6/LingTai.app/Contents/MacOS/LingTai" "Desktop App"
assert_file "$success/home/.local/share/lingtai-desktop/receipts/0.1.6.json" "Desktop receipt"
...
grep -qx 'https://raw.githubusercontent.com/Lingtai-AI/lingtai-desktop/v0.1.6/scripts/install-macos-app.py' "$success/curl.log"
grep -qx 'https://raw.githubusercontent.com/Lingtai-AI/lingtai-desktop/v0.1.6/scripts/desktop_user_cli.py' "$success/curl.log"
grep -qx 'https://raw.githubusercontent.com/Lingtai-AI/lingtai-desktop/v0.1.6/scripts/verify-app-archive.py' "$success/curl.log"
grep -qx 'https://api.github.com/repos/Lingtai-AI/lingtai-desktop/releases/tags/v0.1.6' "$success/curl.log"
grep -qx 'https://github.com/Lingtai-AI/lingtai-desktop/releases/download/v0.1.6/LingTai-0.1.6-macOS-universal.app.tar.gz' "$success/curl.log"
grep -qx 'https://github.com/Lingtai-AI/lingtai-desktop/releases/download/v0.1.6/LingTai-0.1.6-macOS-universal.app.manifest.json' "$success/curl.log"
