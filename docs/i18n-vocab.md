...
| self (the agent itself) | self | 自身 | 本我 |
| spawn/create avatar | spawn | 创建 | 化出/化身 |
| spirit (running agent) | spirit | 器灵 | 器灵 |
...
| tool | tool | 工具 | 器 |
| file | file | 文件 | 文卷 |
| working directory | working dir | 工作目录 | 工作目录 |
